...
async def timer(botti, message, botData):
    ...
    try:
        ...
        await modules.bottiHelper._sendMessagePingAuthor(message, modules.bottiHelper._invalidParams("!timer"))      
        return
...
async def timercancel(botti, message, botData):
    ...
    try:
        ...
        await modules.bottiHelper._sendMessagePingAuthor(message, modules.bottiHelper._invalidParams("!timercancel"))      
        return
